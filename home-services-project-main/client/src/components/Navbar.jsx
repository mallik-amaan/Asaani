          ...
          <>
            ...
            {loginRole === 'admin' ? <div className="relative">
              ...
              <div className="absolute right-0 mt-2 bg-white w-[200px] rounded-lg">
                ...
                <button className="flex p-2 hover:bg-[#EFEFF2] hover:text-[#232630]" onClick={()=> navigate("/profile")}><span><img src={person} className="mr-3 "/></span>User information</button>
                <button className="flex p-1 hover:bg-[#EFEFF2] hover:text-[#232630]" onClick={() => navigate(`/customer-ordered-list/${userId}`)}><span><img src={form} className="mr-3"/></span>Repair orders</button>
                <button className="flex pt-2 p-1 hover:bg-[#EFEFF2] hover:text-[#232630]" onClick={() => navigate(`/customer-ordered-history/${userId}`)}><span><img src={watch} className="mr-3"/></span>Repair history</button>
                ...
                <button className="flex pt-2 p-2 border-t border-grey300 hover:bg-[#EFEFF2] hover:text-[#232630]" onClick={logout}><span><img src={exit} className="mr-3"/></span>Out of the system</button>
              </ul>
              </div>
              )}
            </div> 
